...
client.on
client.on("ready", () => {
    client.user.setActivity("Anemia", { type: "PLAYING"})
})
...
const fs = require('fs')
 ...
 client.on('guildCreate', guild =>{
    ...
    const channelId = '958323892345241682'; //put your channel ID here
...
client.on('guildDelete', guild =>{
    const channelId = '958323892345241682';//add your channel ID
