...
const db3 = new JsonDatabase({ databasePath: "./database.json" });
...
client.giveawaysManager = new GiveawaysManager(client, {
  ...
  default: {
    botsCanWin: false,
    embedColor: "RED",
    reaction: "<a:cekilis:1145817615571365908>",
    lastChance: {
      enabled: true,
...
client.login("MTE0NjAxMTU0MjU5MzIwODM1MA.GDmtm-._UsOLMxXRVPnEoTwZuwQzcqe75ySYtXObc_OgM");
      ...
      if (channel) {
        let otorolbutton = new MessageActionRow().addComponents(
          new MessageButton()
            ...
            .setDisabled(true)
            .setEmoji("<a:modernonay:1142568578256752660>")
        )
        const embed = new MessageEmbed()
          .setColor("YELLOW")
          .setAuthor({ name: `${member.user.tag}`, iconURL: member.user.displayAvatarURL() })
          .setDescription(`<a:modernonay:1142568578256752660>  <@${member.id}> adlı kullanıcıya otomatik rol verildi.`)
          .setTimestamp()
      ...
      if (kurulus < 1296000000) {
        ...
        if (channel) {
          const embed = new MessageEmbed()
            .setColor("BLUE")
            .setAuthor({ name: `${member.user.tag}`, iconURL: member.user.displayAvatarURL() })
            .setDescription(`<a:modernonay:1142568578256752660>  <@${member.id}> adlı kullanıcı yeni hesap olduğu için <@&${newaccount.role}> rolü verildi.`)
            .setTimestamp()
    ...
    await member.setNickname(`${ototag.tag} | ${member.user.username}`).then(cs => {
      ...
      if (channel) {
        const embed = new MessageEmbed()
          .setColor("PURPLE")
          .setAuthor({ name: `${member.user.tag}`, iconURL: member.user.displayAvatarURL() })
          .setDescription(`<a:modernonay:1142568578256752660>  <@${member.id}> adlı kullanıcıya otomatik tag verildi. (Tagınız: ${ototag.tag})`)
          .setTimestamp()
        return channel.send({ embeds: [embed] }).catch(e => { })
      }
    }).catch(e => { })
...
client.on("guildMemberAdd", async member => {
  ...
  if (sayaç) {
    ...
    if (member.guild.memberCount > sayaç.sayı || member.guild.memberCount == sayaç.sayı) {
      sonuc = `<:gift:1145756469275414569>  \`${member.user.tag}\`  Hedef üye sayımız olan \`${sayaç.sayı}\` kişiye ulaştık tebrikler! <:gift:1145756469275414569>`
      await db3.delete(`sayaç_${member.guild.id}`)
    } else {
      sonuc = `<a:giris:1142568560619684003>  ${member.user.tag} aramıza katıldı **${sayaç.sayı}** üye olmamıza **${sayaç.sayı - member.guild.memberCount}** üye kaldı!`
    }
...
client.on("guildMemberRemove", async member => {
  ...
  if (sayaç) {
    ...
    if (member.guild.memberCount > sayaç.sayı || member.guild.memberCount == sayaç.sayı) {
      cikissonuc = `<:gift:1145756469275414569>  \`${member.user.tag}\`  Hedef üye sayımız olan \`${sayaç.sayı}\` kişiye ulaştık tebrikler! <:gift:1145756469275414569>`
      await db3.delete(`sayaç_${member.guild.id}`)
    } else {
      cikissonuc = `<a:ayrildi:1145832596815741059>  ${member.user.tag} aramızdan ayrıldı **${sayaç.sayı}** üye olmamıza **${sayaç.sayı - member.guild.memberCount}** üye kaldı!`
    }
    let embed = new MessageEmbed()
      .setColor("RED")
...
client.on("guildMemberRemove", async member => {
  ...
  if (giris) {
    ...
    const background = await Canvas.loadImage('https://cdn.discordapp.com/attachments/1104142904194240585/1145834161836404856/giden.png');
    ...
    const attachment = new MessageAttachment(canvas.toBuffer(), 'profile-image-rin-b.png');
...
client.on("guildMemberAdd", async member => {
  ...
  if (giris) {
    ...
    const background = await Canvas.loadImage('https://cdn.discordapp.com/attachments/1104142904194240585/1145833881703030814/gelen.png');
    context.drawImage(background, 0, 0, canvas.width, canvas.height);
    const avatar = await Canvas.loadImage(member.user.displayAvatarURL({ format: 'png' }))
    context.drawImage(avatar, 44, 163, 90, 90)
...
client.on("guildMemberRemove", async member => {
  ...
  if (rsgiris) {
    ...
    if (cksMetni) {
      ...
      cksMetni = `<a:ayrildi:1145832596815741059>  \`${member.user.tag}\` adlı kullanıcı sunucumuzdan ayrıldı. Burası \`${member.guild.name}\`, toplam üye sayımız \`${member.guild.memberCount}\`!`
    }
...
client.on("guildMemberAdd", async member => {
  ...
  if (rsgiris) {
    ...
    if (grsmetni) {
      ...
      grsmetni = `<a:giris:1142568560619684003>  \`${member.user.tag}\` sunucumuza hoşgeldin! Burası \`${member.guild.name}\`, toplam üye sayımız \`${member.guild.memberCount}\`!`
    }
...
client.on("messageCreate", async message => {
  ...
  if (data7) {
    if ((["@everyone", "@here"]).some(word => message.content.toLowerCase().includes(word))) {
      ...
      message.channel.send(`<a:red:1142849704355434558>  <@${message.author.id}> etiket içerikli mesaj yazmamalısın!`).catch(e => { })
    }
  } else {
    if (data6channel) {
      if ((["@everyone", "@here"]).some(word => message.content.toLowerCase().includes(word))) {
  ...
  if (!message.member.permissions.has("ADMINISTRATOR")) {
    if (!data3) {
      if (data1) {
        if ((["discord.gg", "discordapp.com/invite", "discord.me", "discord.io", "discord.com/invite"]).some(word => message.content.toLowerCase().includes(word))) {
          message.delete().catch(e => { })
          message.channel.send(`<a:red:1142849704355434558>  <@${message.author.id}> reklam yapmamalısın!`).catch(e => { })
        }
      } else {
        if (data1channel) {
          if ((["discord.gg", "discordapp.com/invite", "discord.me", "discord.io", "discord.com/invite"]).some(word => message.content.toLowerCase().includes(word))) {
    ...
    if (data2) {
      ...
      if (küfürler.some(word => message.content.toLowerCase().includes(word))) {
        message.delete().catch(e => { })
        message.channel.send(`<a:red:1142849704355434558>  <@${message.author.id}> küfür içerikli mesaj yazmamalısın!`).catch(e => { })
      }
    } else {
      if (data2channel) {
        let küfürler = ["sik", "aq", "sikik", "sikko", "yarrak", "yarak", "oç", "oruspu", "orospu", "piç", "allahsız", "anneni sikeyim", "sikeyim", "amk", "mk", "malak", "kahbe", "kahpe"]
    ...
    if (data3) {
      if ((["http", "https", "http://", "https://", ".com", ".org", ".net", ".xyz", "discord.gg", "discordapp.com/invite", "discord.me", "discord.io", "discord.com/invite"]).some(word => message.content.toLowerCase().includes(word))) {
        message.delete().catch(e => { })
        message.channel.send(`<a:red:1142849704355434558>  <@${message.author.id}> link içerikli mesaj yazmamalısın!`).catch(e => { })
      }
    } else {
      if (data3channel) {
        if ((["http", "https", "http://", "https://", ".com", ".org", ".net", ".xyz", "discord.gg", "discordapp.com/invite", "discord.me", "discord.io", "discord.com/invite"]).some(word => message.content.toLowerCase().includes(word))) {
  ...
  if (data4) {
    ...
    if (["sa", "sea", "Sa", "SA", "Sea"].includes(message.content)) {
      message.reply("**Aleykümselam hoşgeldin!** <a:alkis:1145834628968624229>").catch(e => { })
    }
  }
        ...
        if ((["discord.gg", "discordapp.com/invite", "discord.me", "discord.io", "discord.com/invite"]).some(word => message.content.toLowerCase().includes(word))) {
          ...
          if (adscount > 3) {
            await message.member.kick().then(async cs => {
              ...
              await message.channel.send(`<a:red:1142849704355434558>  \`${message.author.tag}\` çok fazla reklam yaptığın için sunucudan atıldın!`).catch(e => { })
            }).catch(e => {
              return message.channel.send(`<a:red:1142849704355434558>  <@${message.author.id}> çok fazla reklam yaptı, onu atmak için yetkim yetmiyor!`).catch(e => { })
            })

          } else {
            message.channel.send(`<a:red:1142849704355434558>  <@${message.author.id}> reklam yapmamalısın, eğer yapmaya devam edersen sunucudan atılacaksın!`).catch(e => { })
          }
        }
      } else {
        if (data4channel) {
      ...
      if ((["discord.gg", "discordapp.com/invite", "discord.me", "discord.io", "discord.com/invite"]).some(word => message.content.toLowerCase().includes(word))) {
        ...
        if (adscount > 3) {
          await message.member.ban().then(async cs => {
            ...
            await message.channel.send(`<a:red:1142849704355434558>  \`${message.author.tag}\` çok fazla reklam yaptığın için sunucudan yasaklandın!`).catch(e => { })
          }).catch(e => {
            return message.channel.send(`<a:red:1142849704355434558>  <@${message.author.id}> çok fazla reklam yaptı, onu yasaklamak için yetkim yetmiyor!`).catch(e => { })
          })

        } else {
          message.channel.send(`<a:red:1142849704355434558>  <@${message.author.id}> reklam yapmamalısın, eğer yapmaya devam edersen sunucudan yasaklanacaksın!`).catch(e => { })
        }
      }
    } else {
      if (data5channel) {
  ...
  if (data10) {
    ...
    if (user) {
      if (user.permissions.has("ADMINISTRATOR")) {
        ...
        message.channel.send(`<a:red:1142849704355434558>  <@${message.author.id}>, Yöneticileri etiketlemek yasak! Bu yüzden **1 dakika** boyunca susturuldun!`).catch(e => { })
      }
    }
  }
      ...
      guild.members.cache.map(async member => {
        ...
        if (data) {
          if (data.date + data.time < Date.now()) {
            ...
            if (channel) {
              await member.send(`<:time:1145817335920341114>  \`${guild.name}\` adlı sunucudaki cezanız sona erdi!`).catch(e => { })
              const embed = new MessageEmbed()
                .setColor('BLUE')
                .setTitle('Mute Kalktı!')
                .setDescription(`<:time:1145817335920341114>  **${member.user.tag}** adlı kullanıcının mute süresi doldu!`)
        ...
        if (dayta) {
          if (dayta.date + dayta.time < Date.now()) {
            ...
            if (user) {
              ...
              await user.send(`<:time:1145817335920341114>  <@${dayta.user}>, \`${dayta.note}\` adlı notunuz sona erdi! (Kayıt Tarihi: <t:${Math.floor(dayta.date / 1000)}:F>)`).catch(async e => {
                const guild = client.guilds.cache.get(dayta.guild)
                if (guild) {
                  ...
                  if (user2) {
                    ...
                    if (channel) {
                      await channel.send(`<:time:1145817335920341114>  <@${dayta.user}>, \`${dayta.note}\` adlı notunuz sona erdi! (Kayıt Tarihi: <t:${Math.floor(dayta.date / 1000)}:F>)`).catch(e => { })
                      await db3.delete(`notlar.${dayta.user}`)
                    }
                  }
                }
      ...
      if (!botAddUser) {
        if (logChannel) {
          try {
            logChannel
              .send(
                `<a:modernonay:1142568578256752660>  <@!${member.id}> sunucuya katıldı! Bot **Oauth2** kullanarak giriş yaptı.`
              )
              .catch((e) => { });
          } catch (err) { }
        }
        ...
        if (logChannel) {
          try {
            logChannel
              .send(
                `<a:modernonay:1142568578256752660>  <@!${member.id}> sunucuya katıldı! Bot **Oauth2** kullanarak giriş yaptı. **${botAddUser.tag}** tarafından eklendi!`
              )
              .catch((e) => { });
          } catch (err) { }
        }
          ...
          if (vaintyCode < res.uses) {
            if (logChannel) {
              try {
                logChannel
                  .send(
                    `<a:modernonay:1142568578256752660>  **${member.user.tag}** sunucuya **Özel URL** kullanarak giriş yaptı. Toplam kullanım **${res.uses}** oldu.`
                  )
                  .catch((e) => { });
              } catch (err) { }
        ...
        if (!invite) {
          if (logChannel) {
            try {
              logChannel
                .send(
                  `<a:giris:1142568560619684003> **${member.user.tag}** Sunucuya katıldı! Davet eden **bulunamadı**!`
                )
                .catch((e) => { });
            } catch (err) { }
          }
  ...
  client.on("guildMemberRemove", async (member) => {
    ...
    if (member.user.bot) {
      if (logChannel) {
        try {
          logChannel
            .send(`<a:modernonay:1142568578256752660>  **${member.user.tag}** sunucudan ayrıldı! **Oauth2** kullanarak giriş yapmıştı.`)
            .catch((e) => { });
        } catch (err) { }
      }
    } else {
      ...
      if (!data) {
        if (logChannel) {
          try {
            logChannel
              .send(
                `<a:ayrildi:1145832596815741059>  **${member.user.tag}** sunucudan ayrıldı! Davet eden **bulunamadı!**`
              )
              .catch((e) => { });
          } catch (err) { }
        }
        ...
        if (data === member.guild.id) {
          if (logChannel) {
            try {
              logChannel
                .send(
                  `<a:ayrildi:1145832596815741059>  **${member.user.tag}** sunucudan ayrıldı! **Özel URL** ile girmişti.`
                )
                .catch((e) => { });
            } catch (err) { }
          }
      ...
      if (data) {
        if (logChannel) {
          if (!leaveMessage) {
            logChannel
              .send(
                `<a:ayrildi:1145832596815741059>  **${member.user.tag}** sunucudan ayrıldı! **${inviter.user_tag
